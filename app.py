...
def load_class_names(file_path="labels.txt"):
...
# Dataset preview
if os.path.exists("docs/goodvsbad.png"):
...
if image:
    ...
    <div style='background-color:#0e1117; padding:20px; border-radius:10px; box-shadow:0 0 10px rgba(255,255,255,0.05);'>
        <h3 style='color:{label_color}; text-align:center;'>{emoji} Prediction: <b>{predicted_class}</b></h3>
...
st.markdown("---")
st.caption("Built with ❤️ by Priyal• Powered by TensorFlow + Streamlit")
